...
const CustomButton = ({
  ...
  <g style="transform: scale(0.9); transform-origin: 250px 250px">
    ...
    <text style="line-height:0%;text-align:center" transform="scale(1.25 .8)" letter-spacing="0" word-spacing="0" font-family="sans-serif" text-anchor="middle" stroke-width="12">
      <tspan x="${200 + +fontX}" y="${480 + +fontY}" style="line-height:1.25;-inkscape-font-specification:'Impact Condensed';text-align:center" font-stretch="condensed" font-size="${390 * fontSize}" font-family="Impact" fill="#fff" stroke="#000" stroke-width="13.6845">${text}</tspan>
    </text>
  </g>
`
